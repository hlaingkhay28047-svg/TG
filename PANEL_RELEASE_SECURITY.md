...
- v6.171.0 · 2026-09-17 · SHA-256 `75978290c882…` · 20,952,948 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
