...
- v6.172.0 · 2026-09-17 · SHA-256 `5ff82b1e7cb6…` · 21,013,564 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
