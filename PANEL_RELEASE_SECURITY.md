...
- v6.196.0 · 2026-09-22 · SHA-256 `7602a0f6deb8…` · 24,271,488 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
