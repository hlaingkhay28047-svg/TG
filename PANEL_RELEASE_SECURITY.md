...
- v6.167.2 · 2026-09-16 · SHA-256 `c32a4d200bca…` · 20,916,654 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
