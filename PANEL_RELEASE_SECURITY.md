...
- v6.168.0 · 2026-09-16 · SHA-256 `5d8882b2f571…` · 20,931,237 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
