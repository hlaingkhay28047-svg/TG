...
- v6.197.0 · 2026-09-22 · SHA-256 `12d9bf2e3f1f…` · 24,276,108 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
