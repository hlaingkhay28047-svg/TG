...
- v6.185.0 · 2026-09-20 · SHA-256 `c3c7ad1cde0a…` · 22,012,355 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
