...
- v6.185.0 · 2026-09-20 · SHA-256 `824068d9129f…` · 22,012,317 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
