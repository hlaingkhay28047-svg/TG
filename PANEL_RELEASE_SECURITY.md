...
- v6.169.0 · 2026-09-16 · SHA-256 `be90e1b7db2f…` · 20,939,020 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
