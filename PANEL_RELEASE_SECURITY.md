...
- v6.191.0 · 2026-09-21 · SHA-256 `a752ee5fd625…` · 22,038,302 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
