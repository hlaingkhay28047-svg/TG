...
- v6.178.0 · 2026-09-17 · SHA-256 `6b76e04a4ec7…` · 21,028,375 bytes · adobe_acceptance **pending** — no in-Photoshop checklist on this build; published only if a panel-release run matched this SHA-256 byte for byte
