...
function release() {
  ...
  report("E3) the sweep runs this test as its 267th step, and the landing says 267 tests",
    has(CI, "node test/verify_album_wave_i.js") && steps === 267 && has(LANDING, "267 tests") && !/\b266 tests\b/.test(LANDING),
    { steps });
}
