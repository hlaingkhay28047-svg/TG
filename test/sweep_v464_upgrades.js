...
/* The set this replaced was 116 files totalling 13.8 MB. Shipping the pack at
   ...
   v5.14 — the Thailand scene preset (pr-scnThailand, filling the last real
   gap in the Vietnam/Myanmar/Chinese/Shan family) landed its own verified
   960x640 card photo, taking the pack to 128 files / 15.16 MB (15.151963
...
/* v5.62 — the Concept Art Poster card (concept-poster.jpg) shipped its own
   verified 960x640 photo — generated by the showcase lane from the workflow's
   shipped prompt, centre-cropped and re-encoded to the pack's exact geometry —
...
/* v5.64 — the eight design-series cards (ink-atelier, doll-boudoir,
   gold-chrysanth, lion-dance, lotus-dance, lotus-garden, saigon-glam,
   peony-night) each shipped their own verified 960x640 photo — generated by
   the showcase lane from each workflow's shipped prompt, centre-cropped and
   re-encoded to the pack's exact geometry — taking the pack to 141 files /
...
/* v5.64b — the Derma Skin Pro split-face card and the Blue Silk Boudoir
   ...
   at the source's own composition). The v4.84 boot-payload budget then
   caught the ten new cards pushing a pgWf launch past its byte ceiling, so
   all ten were re-encoded lighter (q79) — same pixels, ~13% fewer bytes —
...
/* 2026-09-07, v6.32.2 — the Reference Scenes card lands (the owner's two-image workflow, its prompt word for word; one 960x640
   file at the pack's q79), taking the pack to 194 files / 20.37 MB (20.366194 exactly — rounded up, same rule). */
const PREV_MB = 20.37;
