...
function releasePins() {
  ...
  report("D3) CI runs this test and the landing says how many tests the suite runs (256 when this wave shipped, 257 since 6.115.0 added verify_ux_wave_6115, 258 since 6.116.0 added verify_ux_wave_6116, 259 since 6.117.0 added verify_ux_wave_6117, 260 since 6.118.0 added verify_ux_wave_6118, 261 since 6.119.0 added verify_ux_wave_6119, 262 since 6.120.0 added verify_ux_wave_6120, 263 since 6.121.0 added verify_album_designer, 264 since 6.122.0 added verify_album_wave_g, 265 since 6.123.0 added verify_prop_wave_h, 266 since 6.124.0 added verify_selection_swap, 267 since 6.125.0 added verify_album_wave_i, 268 since 6.127.0 added verify_skin_age_guard, 269 since 6.127.1 added verify_panel_v2_layer, 270 since 6.128.0 added verify_gen_loading_billing, 271 since 6.129.0 added verify_scene_frame_6129, 272 since 6.130.0 added verify_admin_wave_6130, 273 since 6.131.0 added verify_usage_ledger_6131, 274 since 6.132.0 added verify_scene_lock_agreement_6132, 275 since 6.133.0 added verify_horse_straw_6133, 276 since 6.134.0 added verify_panel_canvas_state_6134, 277 since 6.135.0 added verify_storage_clock_6135, 278 since 6.136.0 added verify_storage_parity_6136, 279 since 6.137.0 added verify_album_light_6137, 280 since 6.138.0 added verify_album_all_6138)", has(CI, "run: node test/verify_ux_wave_6114.js") && (CI.match(/node test\//g) || []).length === 280 && has(LANDING, "280 tests") && !has(LANDING, "255 tests"),
