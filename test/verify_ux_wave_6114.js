...
function releasePins() {
  ...
  report("D3) CI runs this test and the landing says how many tests the suite runs (256 when this wave shipped, 257 since 6.115.0 added verify_ux_wave_6115, 258 since 6.116.0 added verify_ux_wave_6116, 259 since 6.117.0 added verify_ux_wave_6117, 260 since 6.118.0 added verify_ux_wave_6118)", has(CI, "run: node test/verify_ux_wave_6114.js") && (CI.match(/node test\//g) || []).length === 260 && has(LANDING, "260 tests") && !has(LANDING, "255 tests"),
