...
function releasePins() {
  ...
  report("D3) CI runs this test and the landing says how many tests the suite runs (256 when this wave shipped, 257 since 6.115.0 added verify_ux_wave_6115, 258 since 6.116.0 added verify_ux_wave_6116, 259 since 6.117.0 added verify_ux_wave_6117, 260 since 6.118.0 added verify_ux_wave_6118, 261 since 6.119.0 added verify_ux_wave_6119, 262 since 6.120.0 added verify_ux_wave_6120)", has(CI, "run: node test/verify_ux_wave_6114.js") && (CI.match(/node test\//g) || []).length === 262 && has(LANDING, "262 tests") && !has(LANDING, "255 tests"),
