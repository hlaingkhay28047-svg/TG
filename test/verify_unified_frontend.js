...
check("the web app requests a temporary URL from ONE explicit control — the Account card's Panel button under Setup (v6.33.1 ONE PLACE: the Home, Tutorials and Account Center door buttons are gone)",
  ...
  !app.includes('id="unifiedDownload"') && !app.includes("data-panel-intent"));
