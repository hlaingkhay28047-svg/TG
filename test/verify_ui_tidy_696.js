...
async function appWalk(browser) {
  ...
  report("B3) the ceiling is three whole lines, it rescues descriptions a two-line ceiling would cut, and a clear majority of the 199 end on their own word",
    Math.abs(a.ceiling - 3) < 0.05 && a.allOpen.n === 199 && a.natWf.n === 199 &&   /* 6.123.0 — 197 cards since the three wave H cards; 198 since 6.124.0 added Selection Swap & Fill; 199 since 6.133.0 added Horse & Straw */
...
async function panelWalk(browser) {
  ...
  report("C2) three whole lines in the panel too, and the marker is exact: every cut description marked, no uncut one marked, at render and after every group is tapped open",
    ...
    b.atRender.mismatch === 0 && b.allOpen.mismatch === 0 && a.tapped >= 8 && a.allOpen.n === 199, { a, b: { tapped: b.tapped, allOpen: b.allOpen } });
