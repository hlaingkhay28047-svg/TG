...
const DECLARED = [
  ...
  /* 6.30.0 — Portrait Scene's card after + Golden Rice Field thumbnail re-shot with a pose lock; rev 3, the rev-2 copies cleared. */
  { tag: "./__lib-purge-v6-30-0-portrait-card",
  ...
  /* 6.32.1 — three hub cards re-made (Color Tone after, Face Clarity before + after, Upscale after): four files, rev 2. */
  { tag: "./__lib-purge-v6-32-1-repair-cards",
    re: /\/lib\/wf\/imagine\/card-(colortone-after|faceclear-(before|after)|upscale-after)\.jpg$/ },
  /* 6.113.0 — the brand model changed face: 501 pictures re-shot on the new
  ...
  { tag: "./__lib-purge-v6-113-0-face-imagine",
  ...
  { tag: "./__lib-purge-v6-113-0-face-imagine-th",
  ...
  { tag: "./__lib-purge-v6-113-0-face-lookchips",
  ...
  { tag: "./__lib-purge-v6-113-0-face-looks",
  ...
  { tag: "./__lib-purge-v6-113-0-face-vid",
