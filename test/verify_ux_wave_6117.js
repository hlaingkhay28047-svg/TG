...
function releasePins() {
  ...
  report("D3) CI runs this test right after the wave B3 + R1 step and the landing says how many tests the suite runs (259 when this wave shipped, 260 since 6.118.0 added verify_ux_wave_6118, 261 since 6.119.0 added verify_ux_wave_6119)",
    ...
    (CI.match(/node test\//g) || []).length === 261 && has(LANDING, "261 tests") && !has(LANDING, "258 tests"), { steps: (CI.match(/node test\//g) || []).length });
}
