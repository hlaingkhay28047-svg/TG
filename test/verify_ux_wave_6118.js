...
function releasePins() {
  ...
  report("E3) CI runs this test right after the R2 + B2 step and the landing says how many tests the suite runs (260 when this wave shipped, 261 since 6.119.0 added verify_ux_wave_6119, 262 since 6.120.0 added verify_ux_wave_6120)",
    ...
    (CI.match(/node test\//g) || []).length === 262 && has(LANDING, "262 tests") && !has(LANDING, "259 tests"), { steps: (CI.match(/node test\//g) || []).length });
}
