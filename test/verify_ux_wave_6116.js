...
function releasePins() {
  ...
  report("D3) CI runs this test right after the wave B1 band and the landing says how many tests the suite runs (258 when this wave shipped, 259 since 6.117.0 added verify_ux_wave_6117, 260 since 6.118.0 added verify_ux_wave_6118, 261 since 6.119.0 added verify_ux_wave_6119, 262 since 6.120.0 added verify_ux_wave_6120)",
    ...
    (CI.match(/node test\//g) || []).length === 262 && has(LANDING, "262 tests") && !has(LANDING, "257 tests"), { steps: (CI.match(/node test\//g) || []).length });
}
