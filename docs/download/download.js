...
(() => {
  ...
  function render(data) {
    ...
    $("#downloadFacts").replaceChildren(
      ...
      fact("Panel version", value(panel.latest_version, "6.28.1")),
    );
  ...
  async function requestDownload() {
    ...
    try {
      ...
      $("#issuedMessage").textContent = `Version ${value(body.version, "6.28.1")} was authorized. The address is valid only for this short delivery window.`;
