...
const SVG_MAP = [
  { has: 'd="M3 12a9 9 0 1 0 3-6.7"', img: '<img class="icn ic-sa" alt="" src="icons/ui/st-reset-muted.png">' },
  { has: 'class="st-tgi"', img: '<img class="icn st-tgi" alt="" src="icons/ui/st-target-gold.png">' },
  { has: 'd="M6 18 18 6"', img: '<img class="st-thph" alt="" src="icons/ui/st-thumb-ph-muted.png">' }
];
...
const PRELUDE_NAMES = [
  ...
  "finishPassOn", "v2RenderFinishNote",
