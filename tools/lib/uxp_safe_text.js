...
const GLYPHS = {
  ...
  "➡": { word: "", icon: "i-arrow", note: "➡ DRAWS — SETTLED on 6.137.0. At 52px beside a private-use control the arrow is plainly there: a white arrow on a blue plate, nothing like the empty outlined box the control draws. My .notdef reading was WRONG. Still swapped for the i-arrow sprite, which is a deliberate choice and not a need: a sprite cannot depend on the host font at all" },
