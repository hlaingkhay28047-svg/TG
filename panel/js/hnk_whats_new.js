...
"use strict";
var WHATS_NEW = [
  { v:"5.94.0", kind:"page", ref:"pgCreate",
    t:{my:"ရွေးလိုက်တဲ့ ratio နဲ့ size အမှန်ထွက်ပါပြီ",en:"The ratio and size you pick now really come out",shn:"ratio လႄႈ size ဢၼ်လိူၵ်ႈ ဢွၵ်ႇမႃးတႄႉယဝ်ႉ",kac:"Lata ai ratio hte size teng sha pru wa sai",th:"อัตราส่วนและขนาดที่เลือกออกมาจริงแล้ว",zh:"你选择的比例和尺寸现在真的会生效",vi:"Tỷ lệ và kích thước bạn chọn giờ thực sự ra đúng",id:"Rasio dan ukuran yang kamu pilih kini benar-benar diterapkan",ms:"Nisbah dan saiz yang anda pilih kini benar-benar digunakan"},
    s:{my:"Seedream v4/v4.5 မှာ ratio ရွေးလို့ရပေမဲ့ တကယ်မပါခဲ့ဘူး — အခု မလိုတဲ့ခလုတ်ကို ဖျောက်ထားပါပြီ။ Size က ratio ပေါ်မူတည်တဲ့ model တွေမှာလည်း ကြိုပြောပါပြီ",en:"Seedream v4/v4.5 let you pick a ratio that was never sent — that control is now hidden. And where size comes from the ratio, the app says so before you spend a credit",shn:"Seedream v4/v4.5 လိူၵ်ႈ ratio လႆႈသေတႃႉ ဢမ်ႇသူင်ႇ — ယၢမ်းလဵဝ် ဢိုတ်းဝႆႉ",kac:"Seedream v4/v4.5 hta ratio lata mai tim n sa ai — ya gaw makoi da sai",th:"Seedream v4/v4.5 เคยให้เลือกอัตราส่วนที่ไม่เคยถูกส่ง — ตอนนี้ซ่อนแล้ว",zh:"Seedream v4/v4.5 曾允许选择从未被发送的比例 — 该控件现已隐藏",vi:"Seedream v4/v4.5 từng cho chọn tỷ lệ không bao giờ được gửi — nay đã ẩn",id:"Seedream v4/v4.5 dulu membiarkan memilih rasio yang tak pernah dikirim — kini disembunyikan",ms:"Seedream v4/v4.5 dahulu membenarkan pilihan nisbah yang tidak pernah dihantar — kini disembunyikan"} },
  { v:"5.93.0", kind:"page", ref:"pgHome",
    t:{my:"ဝင်လို့မရရင် ဘာကြောင့်လဲ ရှင်းရှင်းပြောပါပြီ",en:"When sign-in fails, it now tells you why",shn:"ၶဝ်ႈဢမ်ႇလႆႈၸိုင် ၸႅင်ႈလႅင်းဝႃႈသင်",kac:"Shang n mai yang hpa majaw re tsun sai",th:"ถ้าเข้าสู่ระบบไม่ได้ ตอนนี้บอกสาเหตุแล้ว",zh:"登录失败时，现在会说明原因",vi:"Khi đăng nhập lỗi, giờ sẽ nói rõ vì sao",id:"Saat gagal masuk, kini dijelaskan sebabnya",ms:"Apabila log masuk gagal, kini ia menyatakan sebabnya"},
    s:{my:"ခဏစောင့်ရမလား၊ စကားဝှက် မှားနေလား၊ အင်တာနက် ပြဿနာလား — အခု ခွဲပြီး ပြောပါတယ်။ ကီးဘုတ်က Go ခလုတ်နဲ့လည်း ဝင်လို့ရပါပြီ",en:"Whether to wait, fix your password, or check your connection — the app now says which. And the keyboard's Go key signs you in",shn:"ပႂ်ႉၼႃႇ၊ ၶေႃႈလပ်ႉၽိတ်း၊ ဢိၼ်ႇတိူဝ်ႇၼႅတ်ႉ — ၸႅင်ႈလႅင်းယဝ်ႉ။ ၼဵၼ် Go ၵေႃႈၶဝ်ႈလႆႈ",kac:"La ra na, password shut ai, sh'ning internet — ya tsun dan sai. Keyboard Go mung shang mai sai",th:"ต้องรอ ต้องแก้รหัสผ่าน หรือปัญหาเน็ต — ตอนนี้บอกชัด และปุ่ม Go บนคีย์บอร์ดก็เข้าสู่ระบบได้",zh:"是要等待、密码错误，还是网络问题 — 现在会分清楚。键盘上的 Go 键也能登录",vi:"Cần đợi, sai mật khẩu, hay lỗi mạng — giờ ứng dụng nói rõ. Phím Go trên bàn phím cũng đăng nhập được",id:"Harus menunggu, kata sandi salah, atau masalah koneksi — kini dijelaskan. Tombol Go di keyboard juga bisa masuk",ms:"Perlu menunggu, kata laluan salah, atau masalah sambungan — kini dinyatakan. Kekunci Go pada papan kekunci juga boleh log masuk"} },
